...
erefDate    = datetime.datetime(2008,9,1,23,59,59)
refDateList = dateList(srefDate, erefDate, shift = 'month')
OMNIfnames  = getOMNIfiles(locDateList,'/home/ehab/SWData','5min')
if refDateList in locDateList:
 pass
else:
 OMNIfnames = sorted(OMNIfnames + getOMNIfiles(refDateList,'/home/ehab/SWData','5min'))
...
stride = 10
SWPDateRng, cepochs, KSVals, KSDist, aepochs = omniDataCorr(srefDate, erefDate, startDate, endDate, epochs, SWP, binStride = stride, CorrTime = 'Day')
